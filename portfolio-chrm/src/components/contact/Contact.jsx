...
const Contact = () => {
  ...
  const sendEmail = (data) => {
    ...
    if (name.length === 0 || email.length === 0 || subject.length === 0) {
      ...
      return (
        <Modal
          ...
          description={"Você não preencheu todos os campos corretamente!"}
        />
      );
    }
    ...
    emailjs
      ...
      description={
        "Seu e-mail foi enviado com sucesso para mim. Obrigado por entrar em contato!"
      }
  ...
  return (
    <section className="contact section" id="contact">
      ...
      <span className="section_subtitle">Fale comigo</span>
      ...
      <div className="contact_container grid container">
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card_data">cahenromar@gmail.com</span>

              <a href="mailto:cahenromar@gmail.com" className="contact_button">
                Clique aqui{" "}
            ...
            <div className="contact_card">
              ...
              <span className="contact_card_data">(14) 99787-6493</span>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card_data">Veja mais sobre mim !</span>

              <a
                href="https://www.linkedin.com/in/caiohenriquechrm/"
                target="_blank"
        ...
        <div className="contact_content">
          ...
          >
            <h3 className="contact_form_title">Me mande um e-mail</h3>
            <div className="contact_form_div">
              <label className="contact_form_tag">Nome</label>
              <input
                {...register("name")}
                type="text"
                name="name"
            ...
            <div className="contact_form_div contact_form_area">
              <label className="contact_form_tag">Assunto</label>
              <textarea
                {...register("subject")}
                name="subject"
                cols="30"
